...
<html lang="en">
  ...
  <body>
    ...
    <section class="services">
      <a href="./service - Wash and Fold.html">
        <div class="service-item">
          <div class="icon">
            <img src="./Assets/IMG/washnfold.png" alt="Wash and Fold " width="100px" height="100px"/>
          </div>
          <h3>Wash and Fold</h3>
          <p>Standard</p>
        </div>
      ...
      <a href="./service - Wash Dry and Iron.html">
        <div class="service-item">
          <div class="icon">
            <img src="./Assets/IMG/iron-board.png" alt="Wash Dry and Iron" width="100px" height="100px"/>
          </div>
      ...
      <a href="./service - Dry Cleaning.html">
        <div class="service-item">
          <div class="icon">
      ...
      <a href="./service - iron only.html">
        <div class="service-item">
          <div class="icon">
            <img src="./Assets/IMG/iron.png" alt="Iron Only" width="100px" height="100px"/>
          </div>
          <h3>Iron Only</h3>
          <p>Standard</p>
        </div>
      ...
      <a href="./service - Curtain Washing.html">
        <div class="service-item">
          <div class="icon">
      ...
      <a href="./service - Stain Removal.html">
        <div class="service-item">
          <div class="icon">
      ...
      <a href="./service - Shoe Cleaning.html">
        <div class="service-item">
          <div class="icon">
      ...
      <a href="./service - Urgency Services.html">
        <div class="service-item">
          <div class="icon">
